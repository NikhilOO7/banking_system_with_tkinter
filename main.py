...
def log_in(event):
    ...
    try:
        ...
        if pin_number_var.get() != file_data[1]:
            raise messagebox.showerror("Error", "Wrong Password")
    ...
    # Catch exception if we couldn't open the file or PIN entered did not match account PIN
        ...
        messagebox.showerror("Error", "Please Enter Details carefully")
...
def perform_deposit():
    ...
    # Catch and display exception as a 'showerror' messagebox with a title of 'Transaction Error' and the text of the exception
        ...
        messagebox.showerror("Trsnsaction Error", "Invalid Transaction!")
...
def perform_withdrawal():
    ...
    try:
        ...
        #       contents, and finally configure back to state='disabled' so it cannot be user edited.
            ...
            messagebox.showerror("Error", "Insufficient Balance to make transaction")
        # Change the balance label to reflect the new balance
        balance_var.set(str(account.balance))
        balance_label = tk.Label(win, font=12, text = "Balance: $"+ balance_var.get())
        balance_label.grid(row=1, column=1, sticky="nsew")
    ...
    # Catch and display any returned exception as a messagebox 'showerror'
        ...
        messagebox.showerror("Error", "Invalid Transaction!", ValueError)
...
def create_login_screen():
    ...
    button1 = tk.Button(win, padx=40, pady=40, fg='black', font=('arial', 12), text='1')
    button1.bind('<Button-1>', handle_pin_button)
    button1.grid(row=2, column=0, sticky="nsew")

    button2 = tk.Button(win, fg='black', font=('arial', 12), text='2')
    button2.bind('<Button-1>', handle_pin_button)
    button2.grid(row=2, column=1, sticky="nsew")

    button3 = tk.Button(win,fg='black', font=('arial', 12), text='3')
    ...
    button4 = tk.Button(win, padx=40, pady=40, fg='black', font=('arial', 12), text='4')
    button4.bind('<Button-1>', handle_pin_button)
    button4.grid(row=3, column=0, sticky="nsew")

    button5 = tk.Button(win, fg='black', font=('arial', 12), text='5')
    button5.bind('<Button-1>', handle_pin_button)
    button5.grid(row=3, column=1, sticky="nsew")

    button6 = tk.Button(win,fg='black', font=('arial', 12), text='6')
    ...
    button7 = tk.Button(win, padx=40, pady=40, fg='black', font=('arial', 12), text='7')
    button7.bind('<Button-1>', handle_pin_button)
    button7.grid(row=4, column=0, sticky="nsew")

    button8 = tk.Button(win, fg='black', font=('arial', 12), text='8')
    button8.bind('<Button-1>', handle_pin_button)
    button8.grid(row=4, column=1, sticky="nsew")

    button9 = tk.Button(win,fg='black', font=('arial', 12), text='9')
    ...
    # Button 0 here
    button0 = tk.Button(win, fg='black', font=('arial', 12), text='0')
