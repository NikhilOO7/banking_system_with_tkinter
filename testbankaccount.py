...
class TestBankAcount(unittest.TestCase):
    ...
    def test_legal_deposit_works(self):
        ...
        legal_deposit = self.account.deposit_funds('5000')
        self.assertEqual(legal_deposit, '6000.0')
    ...
    def test_illegal_deposit_raises_exception(self):
        ...
        # raised.
        self.assertRaises(ValueError, self.account.deposit_funds, 'hello')        

    def test_legal_withdrawal(self):
        # Your code here to test that withdrawing a legal amount subtracts the
        # funds from the balance.
        legal_withdrawal = self.account.withdraw_funds('0')
        self.assertEqual(legal_withdrawal, '1000.0')
    ...
    def test_illegal_withdrawal(self):
        ...
        self.assertRaises(ValueError, self.account.withdraw_funds, 'hello')
    ...
    def test_insufficient_funds_withdrawal(self):
        ...
        in_sufficient_funds = self.account.withdraw_funds('1100')
        self.assertNotEqual(in_sufficient_funds, '-100')
